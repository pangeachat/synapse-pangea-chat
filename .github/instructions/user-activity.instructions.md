...
Three Synapse module endpoints that power the re-engagement system. Called by the [bot engagement doc](../../../pangea-bot/.github/instructions/engagement.instructions.md).
...
The [engagement doc](../../../pangea-bot/.github/instructions/engagement.instructions.md) in `pangea-bot`:
