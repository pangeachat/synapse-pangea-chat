...
- The invite half of a force-join carries `reason: "p.analytics_request"`, which clients set a push rule to silence — an instructor should not be pinged about an invite that is joined a moment later.
